...
var Beneficiario = (function() {
	...
	Beneficiario.prototype.getContaCorrente = function() {
		return (this._contaCorrente ? this._contaCorrente : this._codigo);
	}

	Beneficiario.prototype.getCodigo = function() {
		return (this._codigo ? this._codigo : this._contaCorrente);
	}

	Beneficiario.prototype.comContaCorrente = function(_contaCorrente) {
		this._contaCorrente = _contaCorrente;
		return this;
	}
