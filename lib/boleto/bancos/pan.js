...
var Pan = (function() {
  ...
  Pan.prototype.getDigitoNossoNumero = function(beneficiario){
    ...
    /* TODO: devemos atualizar o DV mesmo quando informado pelo usuário ? */
    if (!beneficiario.comDigitoNossoNumero(digito))
  ...
  Pan.prototype.getImagem = function() {
    return path.join(__dirname, 'logotipos/banco-pan-antigo.png');
  }
